...
def init_db():
    ...
    if user_input.strip() == 'y':
        ...
        #         line = f.readline()
        sql = "INSERT INTO users (id, `name`, `cname`, `email`, `phone_number`, `pwd_hash`, `is_super`, `status`, `ctime`) values (1, 'admin', 'admin', 'admin@admin.com', '13888888888', 'pbkdf2:sha256:150000$ymlosmY7$184ddd6854ef11252a8a0f5b78511773548bb5e9ccf7460360d936d4b72e8bf1', True, True, '{}')"
        db.engine.execute(sql.format(format(datetime.datetime.now())))
